...
public class EntityGoblinMog extends EntityMob implements net.minecraft.entity.boss.IBossDisplayData, IRangedAttackMob, IHandleDT
{
  ...
  public EntityGoblinMog(World world)
  {
    ...
    field_70714_bg.func_75776_a(4, new EntityAIArrowAttack(this, 1.0D, 40, 80, 30.0F));
  ...
  public String func_70005_c_()
  {
    ...
    return net.minecraft.util.StatCollector.func_74838_a("entity.witchery.goblinmog.name");
  }
  ...
  protected void func_70619_bc()
  {
    if (func_82212_n() > 0) {
      ...
      if ((!field_70170_p.field_72995_K) && (func_70661_as().func_75500_f()) && (func_70638_az() != null) && (field_70173_aa - ticksSinceTeleport > 300L))
      {
        ticksSinceTeleport = field_70173_aa;
        teleportToEntity(func_70638_az());
      }
      
      if ((func_70694_bm() == null) && (field_70146_Z.nextInt(100) == 0)) {
  ...
  private double getDistanceSqToPartner() {
    ...
    List mogs = field_70170_p.func_72872_a(EntityGoblinGulg.class, bb);
  ...
  protected void func_70628_a(boolean par1, int par2)
  {
    ...
    if (field_70170_p.field_73012_v.nextInt(2) == 0) {
      func_70099_a(new ItemStack(ItemsMOGS_QUIVER), 0.0F);
    }
  }
  ...
  public void func_82196_d(EntityLivingBase targetEntity, float par2)
  {
    if (func_70694_bm() != null) {
      ...
      double factor = field_70160_al ? 2.5D : 1.5D;
      field_70159_w *= factor;
      field_70181_x *= factor;
      field_70179_y *= factor;
