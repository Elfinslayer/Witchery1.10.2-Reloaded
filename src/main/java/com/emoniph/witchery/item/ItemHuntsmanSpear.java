...
public class ItemHuntsmanSpear extends ItemSword
{
  ...
  public ItemHuntsmanSpear()
  {
    ...
    effectiveMaterial = Item.ToolMaterial.EMERALD;
    effectiveWeaponDamage = (4.0F + effectiveMaterial.func_78000_c() + 1.0F);
    
    func_77656_e(effectiveMaterial.func_77997_a());
  ...
  {
    return effectiveMaterial.func_78000_c();
  }
}
