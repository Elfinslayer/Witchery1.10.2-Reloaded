  ...
  extends TileEntitySpecialRenderer
{
  ...
  public void renderTileEntityAt(BlockWolfHead.TileEntityWolfHead tile, double x, double y, double z, float partialTicks) {
    render((float)x, (float)y, (float)z, tile.func_145832_p() & 0x7, tile.getRotation() * 360 / 16.0F, tile.getSkullType());
  }
  ...
  public void render(float x, float y, float z, int metadata, float rotation, int skullType) {
    ModelWolfHead modelskeletonhead = field_147533_g;
    
    switch (skullType) {
    case 0: 
    default: 
      func_147499_a(WOLF_TEXTURE);
      break;
    case 1: 
      func_147499_a(HELLHOUND_TEXTURE);
    }
  ...
  {
    renderTileEntityAt((BlockWolfHead.TileEntityWolfHead)tile, x, y, z, partialTicks);
  }
}
