...
public class RenderCovenWitch extends RenderLiving
{
  ...
  public RenderCovenWitch()
  {
    ...
    model = ((ModelWitch)field_77045_g);
  }
  ...
  protected void func_82411_a(EntityCovenWitch par1EntityCovenWitch, float par2)
  {
    ...
    if (itemstack != null) {
      ...
      field_76990_c.field_78721_f.func_78443_a(par1EntityCovenWitch, itemstack, 0);
      
      if (itemstack.func_77973_b().func_77623_v()) {
        field_76990_c.field_78721_f.func_78443_a(par1EntityCovenWitch, itemstack, 1);
      }
  ...
  {
    func_82412_a((EntityCovenWitch)par1EntityLiving, par2, par4, par6, par8, par9);
  }
  
  protected void func_77041_b(EntityLivingBase par1EntityLivingBase, float par2)
  {
    func_82409_b((EntityCovenWitch)par1EntityLivingBase, par2);
  }
  
  protected void func_77029_c(EntityLivingBase par1EntityLivingBase, float par2)
  {
    func_82411_a((EntityCovenWitch)par1EntityLivingBase, par2);
  }
  
  public void func_76986_a(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6, float par8, float par9)
  {
    func_82412_a((EntityCovenWitch)par1EntityLivingBase, par2, par4, par6, par8, par9);
  }
  
  protected ResourceLocation func_110775_a(Entity par1Entity)
  {
    return getCovenWitchTextures((EntityCovenWitch)par1Entity);
  }
  
  public void func_76986_a(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
  {
    func_82412_a((EntityCovenWitch)par1Entity, par2, par4, par6, par8, par9);
  }
}
