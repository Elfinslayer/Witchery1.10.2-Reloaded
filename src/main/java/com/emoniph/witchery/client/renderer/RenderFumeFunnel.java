...
public class RenderFumeFunnel extends TileEntitySpecialRenderer
{
  ...
  {
    model = new ModelFumeFunnel(filtered);
  }
  ...
  public void func_147500_a(TileEntity tileEntity, double d, double d1, double d2, float f)
  {
    ...
    renderFumeFunnel(tileEntityYour, tileEntity.func_145831_w(), field_145851_c, field_145848_d, field_145849_e, BlocksOVEN_FUMEFUNNEL);
