...
public class ModelGoblinGulg extends ModelBase
{
  ...
  public ModelGoblinGulg(float f) {
    ...
    bipedBody.func_78789_a(-4.0F, 0.0F, -2.0F, 8, 4, 4);
    bipedBody.func_78793_a(0.0F, 8.0F, 0.0F);
    ...
    bipedRightArm.func_78789_a(-3.0F, -2.0F, -2.0F, 4, 16, 4);
    bipedRightArm.func_78793_a(-6.0F, 2.0F, 0.0F);
    ...
    bipedLeftArm.func_78789_a(0.0F, -2.0F, -2.0F, 4, 16, 4);
    ...
    bipedChest = new ModelRenderer(this, 12, 35);
    bipedChest.func_78789_a(-5.0F, 0.0F, -3.0F, 10, 8, 6);
    bipedChest.func_78793_a(0.0F, 0.0F, 0.0F);
    bipedChest.func_78787_b(64, 64);
    bipedChest.field_78809_i = true;
    setRotation(bipedChest, 0.0F, 0.0F, 0.0F);
  }
  ...
  public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
  {
    ...
    if (i > 0) {
      bipedRightArm.field_78795_f = (-2.0F + 1.5F * func_78172_a(i - par4, 10.0F));
    }
  }
