  ...
  extends EntityFX
{
  ...
  public void func_70071_h_()
  {
    ...
    {
      if (circling) {
        Vec3 motion = Vec3.func_72443_a(field_70159_w, field_70181_x, field_70179_y);
        motion.func_72442_b(0.5F);
        

        field_70159_w = (motion.field_72450_a *= 1.08D);
        field_70181_x = (motion.field_72448_b *= 0.85D);
        field_70179_y = (motion.field_72449_c *= 1.08D);
      } else {
