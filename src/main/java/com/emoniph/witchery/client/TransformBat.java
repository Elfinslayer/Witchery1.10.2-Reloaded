...
public class TransformBat
{
  ...
  public void syncModelWith(EntityLivingBase entity, boolean frontface) {
    if (proxyEntity == null) {
      proxyEntity = new EntityBat(field_70170_p);
    ...
    proxyEntity.func_82236_f(false);
  ...
  public void render(World worldObj, EntityLivingBase entity, double x, double y, double z, RendererLivingEntity renderer, float partialTicks, boolean frontface)
  {
    ...
    double d3 = -proxyEntity.field_70129_M;
    if ((proxyEntity.func_70093_af()) && (!(entity instanceof EntityPlayerSP))) {
      d3 -= 0.125D;
    }
    
    if (entity.func_70115_ae()) {
      Entity ridden = field_70154_o;
      d3 += ridden.func_70042_X() + ((field_70154_o instanceof EntityBroom) ? field_70131_O - 0.2D : 0.0D);
    }
    ...
    Vec3 vec = proxyEntity.func_70040_Z();
    vec.func_72442_b(90.0F);
    GL11.glPushMatrix();
    GL11.glScalef(0.8F, 0.8F, 0.8F);
    proxyEntity.field_70173_aa += 2;
    proxyRenderer.func_76986_a(proxyEntity, x + field_72450_a * 0.75D, y + d3 - 0.6D, z + field_72449_c * 0.75D, frontface ? 0.0F : f1, partialTicks);
    
    proxyEntity.field_70173_aa += 5;
